...
export const CloseTasksButton = ({toggleSideBarFunctionReverse}:TypeOfProps) => {
    return (
        <div onClick={toggleSideBarFunctionReverse} className={`px-2 border-r justify-center border-r-gray-300 dark:border-r-zinc-800 w-[10vw] tablet:hidden bg-white dark:bg-[#121013] h-screen flex items-center`}>
