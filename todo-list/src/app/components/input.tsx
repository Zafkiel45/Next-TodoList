      ...
      >
        ...
        <div className="flex justify-center w-full items-center">
          <button
            ...
            className={`bg-red-500 desktop:py-2 flex items-center justify-center text-white font-medium w-4/5 desktopMini:px-6  tablet:px-4 h-fit py-2 px-9 shadow-md rounded-md`}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
